...
func TestValidateStruct(t *testing.T) {
	...
	tests := []struct {
		...
		// normal rules
		{
			...
			&m1,
			[]*FieldRules{
				Field(&m1.A, &validateAbc{}),
				Field(&m1.B, &validateXyz{}),
			},
			"",
		},
		{
			...
			&m1,
			[]*FieldRules{
				Field(&m1.A, &validateXyz{}),
				Field(&m1.B, &validateAbc{}),
			},
		...
		},
		{
			"t2.4",
			&m1,
			[]*FieldRules{Field(&m1.D, Length(0, 5))},
			"",
		},
		{
			"t2.5",
			&m1,
			[]*FieldRules{Field(&m1.F, Length(0, 5))},
			"",
		},
		{
			"t2.6",
			&m1,
			[]*FieldRules{
				Field(&m1.H, Each(&validateAbc{})),
				Field(&m1.I, Each(&validateAbc{})),
			},
			"",
		},
		{
			...
			&m1,
			[]*FieldRules{
				Field(&m1.H, Each(&validateXyz{})),
				Field(&m1.I, Each(&validateXyz{})),
			},
		...
		// invalid field spec
		{
			...
			&m1,
			[]*FieldRules{Field(m1)},
			ErrFieldPointer(0).Error(),
		},
		{
			"t4.2",
			&m1,
			[]*FieldRules{Field(&m1)},
			ErrFieldNotFound(0).Error(),
		},
		// struct tag
		{
			"t5.1",
			&m1,
			[]*FieldRules{Field(&m1.G, &validateAbc{})},
			"g: error abc.",
		},
		// validatable field
		{
			"t6.1",
			&m2,
			[]*FieldRules{Field(&m2.E)},
			"E: error 123.",
		},
		{
			"t6.2",
			&m2,
			[]*FieldRules{Field(&m2.E, Skip)},
			"",
		},
		{
			"t6.3",
			&m2,
			[]*FieldRules{Field(&m2.E, Skip.When(true))},
			"",
		},
		{
			"t6.4",
			&m2,
			[]*FieldRules{Field(&m2.E, Skip.When(false))},
			"E: error 123.",
		},
		// Required, NotNil
		{
			"t7.1",
			&m2,
			[]*FieldRules{Field(&m2.F, Required)},
			"F: cannot be blank.",
		},
		{
			"t7.2",
			&m2,
			[]*FieldRules{Field(&m2.F, NotNil)},
			"F: is required.",
		},
		{
			"t7.3",
			&m2,
			[]*FieldRules{Field(&m2.F, Skip, Required)},
			"",
		},
		{
			"t7.4",
			&m2,
			[]*FieldRules{Field(&m2.F, Skip, NotNil)},
			"",
		},
		{
			"t7.5",
			&m2,
			[]*FieldRules{Field(&m2.F, Skip.When(true), Required)},
			"",
		},
		{
			"t7.6",
			&m2,
			[]*FieldRules{Field(&m2.F, Skip.When(true), NotNil)},
			"",
		},
		{
			"t7.7",
		...
		},
		{
			"t7.8",
			&m2,
			[]*FieldRules{Field(&m2.F, Skip.When(false), NotNil)},
			"F: is required.",
		},
		// embedded structs
		{
			"t8.1",
			&m3,
			[]*FieldRules{Field(&m3.M3, Skip)},
			"",
		},
		{
			"t8.2",
			&m3,
			[]*FieldRules{Field(&m3.M3)},
			"M3: (A: error abc.).",
		},
		{
			"t8.3",
			&m3,
			[]*FieldRules{Field(&m3.Model3, Skip)},
			"",
		},
		{
			"t8.4",
			&m3,
			[]*FieldRules{Field(&m3.Model3)},
			"A: error abc.",
		},
		{
			"t8.5",
			&m4,
			[]*FieldRules{Field(&m4.M3)},
			"",
		},
		{
			"t8.6",
			&m4,
			[]*FieldRules{Field(&m4.Model3)},
			"",
		},
		{
			"t8.7",
...
func TestValidateStructWithContext(t *testing.T) {
	...
	tests := []struct {
		...
		// normal rules
		{
			...
			&m1,
			[]*FieldRules{
				Field(&m1.A, &validateContextAbc{}),
				Field(&m1.B, &validateContextXyz{}),
			},
			"",
		},
		{
			...
			&m1,
			[]*FieldRules{
				Field(&m1.A, &validateContextXyz{}),
				Field(&m1.B, &validateContextAbc{}),
			},
			"A: error xyz; B: error abc.",
		},
		{
		...
		},
		{
			"t1.4",
			&m1,
			[]*FieldRules{Field(&m1.G, &validateContextAbc{})},
			"g: error abc.",
		},
		// skip rule
		{
			"t2.1",
			&m1,
			[]*FieldRules{Field(&m1.G, Skip, &validateContextAbc{})},
			"",
		},
		{
			"t2.2",
			&m1,
			[]*FieldRules{Field(&m1.G, &validateContextAbc{}, Skip)},
			"g: error abc.",
		},
		// internal error
		{
