...
func TestEach(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			"t1",
			nil,
			"must be an iterable (map, slice or array)",
		},
		{
			"t2",
			map[string]string{},
		...
		{
			"t8",
			map[any]any{"key1": struct{ foo string }{"foo"}},
			"",
		},
		{
			"t9",
		...
		},
		{
			...
			"0: cannot be blank; 2: cannot be blank.",
		},
		{
			"t12",
			[]any{struct{ foo string }{"foo"}},
			"",
		},
		{
			"t13",
			...
			"0: cannot be blank; 1: cannot be blank.",
		},
		{
			"t14",
			[]any{
